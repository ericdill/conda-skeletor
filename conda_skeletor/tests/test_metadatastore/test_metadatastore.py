...
def setup_module():
    ...
    git_url = 'http://github.com/NSLS-II/metadatastore'
    git_rev = '2bf2796f03e438e0861755b73923da325f9a924b'
...
def test_metadatastore_meta_generation():
    global OUTPUT_DIR, SOURCE_DIR
